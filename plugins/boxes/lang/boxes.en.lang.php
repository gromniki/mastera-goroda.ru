...
$L['cfg_box_speedup'] = 'CONNECTING CSS FILES<br>specify the file name and extension in the folder css, situated <b>' . $cfg['mainurl'] . '/' . $cfg['themes_dir'] . '/' .
        $theme . '/css/' . '</b><br>each on a new line';
...
$L['cfg_box_speedupjs'] = 'AREA paste content JS FILE<br>specify the file name and extension in the folder js, situated <b>' . $cfg['mainurl'] . '/' . $cfg['themes_dir'] .
        '/' . $theme . '/js/' . '</b><br>each on a new line';
...
$L['cfg_boxdesc'] = 'description of additional units in order, one per line';
