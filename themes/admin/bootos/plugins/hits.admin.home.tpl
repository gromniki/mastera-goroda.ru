    ...
    <tr>
      ...
      <td>
        <div class="progress" style="margin:0;">
          ...
          <div class="bar bar-success" style="width:{ADMIN_HOME_PERCENTBAR}%;"><span class="amount">{ADMIN_HOME_HITS|cot_declension($this, 'Hits')}</span></div>
          <!-- ELSE -->
          <div class="bar bar-success" style="width:{ADMIN_HOME_PERCENTBAR}%;"></div><span class="amount">{ADMIN_HOME_HITS|cot_declension($this, 'Hits')}</span>
          <!-- ENDIF -->
        </div>
      </td>
    </tr>
